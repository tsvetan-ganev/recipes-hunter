...
public final class Constants {
    public final static String API_KEY = "9e6a705f76e8cd129b7692e570294410";
    public final static String API_ENDPOINT = "http://food2fork.com/api/";
    ...
    public static final String FRAGMENT_FAVOURITES_RECIPES_LIST = "fragment_favourites_recipes_list";
    public static final String FRAGMENT_FAVOURITES_RECIPE_DETAILS = "fragment_favourites_recipe_details";
    ...
    public static final String BUNDLE_ITEM_RECIPES_LIST = "bundle_item_recipes_list";
